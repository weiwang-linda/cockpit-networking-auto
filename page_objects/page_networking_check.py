...
class CockpitNetworkingPage(SeleniumTest):
    ...
    RHVM_DATA_MAP = {
        ...
        "4.2_rhvm_fqdn": "https://bootp-73-199-109.lab.eng.pek2.redhat.com/ovirt-engine/api",
    ...
    SYSTEM_VERSION = "//table[@class='info-table-ct']//td[@id='system_information_os_text']"
    ...
    NETWORK_NICS_OFF = "//div[@id='network-interface-delete-switch']/label[text()='Off']"
    ...
    BOND_SETTING_MEMBERS_CHECKBOX_ENO1 = "//div[@id='network-bond-settings-dialog']//ul[@class='list-group available-interfaces-group dialog-list-ct']//label/span[contains(text(),'eno1')]"
    BOND_SETTING_MEMBERS_CHECKBOX_ENO2 = "//div[@id='network-bond-settings-dialog']//ul[@class='list-group available-interfaces-group dialog-list-ct']//label/span[contains(text(),'eno2')]"
    BOND_SETTING_MEMBERS_CHECKBOX_ENO3 = "//div[@id='network-bond-settings-dialog']//ul[@class='list-group available-interfaces-group dialog-list-ct']//label/span[contains(text(),'eno3')]"
    BOND_SETTING_MEMBERS_CHECKBOX_ENO4 = "//div[@id='network-bond-settings-dialog']//ul[@class='list-group available-interfaces-group dialog-list-ct']//label/span[contains(text(),'eno4')]"
    ...
    BOND_SETTING_PRIMARY_LIST = "//div[@id='network-bond-settings-dialog']//td[@id='network-bond-settings-primary-select']//button[@class='btn btn-default dropdown-toggle']"
    ...
    FIREWALL_BUTTON_ON = "//div[@class='btn-group btn-onoff-ct']//span[text()='On']"
    FIREWALL_BUTTON_OFF = "//div[@class='btn-group btn-onoff-ct']//span[text()='Off']"
    FIREWALL_PUBLIC_ZONE_TABLE = "//div[@class='container-fluid page-ct']//table"
    FIREWALL_ADD_SERVICE_BUTTON = "//button[text()='Add Services…']"
    FIREWALL_SERVICE_BACULA = "//input[@id='bacula']"
    FIREWALL_PRIMARY_BUTTON = "//button[@class='btn btn-primary apply']"
    FIREWALL_SERVICE_LIST_BACULA = "//tr[@data-row-id='bacula']//th[text()='Bacula']"
    FIREWALL_REMOVE_SERVICE = "//button[@class='btn btn-danger pficon pficon-delete']"
    ...
    def check_config_firewall(self):
        ...
        time.sleep(self.SLEEP_TIME)
        #back to the root html and enter firewall frame
        self.driver.switch_to.default_content()
        time.sleep(self.SLEEP_TIME)
        ...
        self.click(self.FIREWALL_BUTTON_OFF)
        time.sleep(self.SLEEP_TIME)
        ...
        self.click(self.FIREWALL_BUTTON_ON)
        time.sleep(self.SLEEP_TIME)
        #check firewalld status via shell
    ...
    def check_add_del_svc_in_firewall(self):
        ...
        self.click(self.FIREWALL_SERVICE_BACULA)
        ...
        #delete service
        self.click(self.FIREWALL_SERVICE_LIST_BACULA)
    ...
    def _add_host_to_rhvm(self, is_vlan=False):
        ...
        try:
            ...
            self._rhvm.add_cluster(self.RHVM_COMPUTE_MAP.get("cluster_name"), data_center_name=self.RHVM_COMPUTE_MAP.get("dc_name"), cpu_type=_host_cpu_type, cluster_level="4.2")
